...
-(void) memoryclear{
    _memory=0;//不用返回memory么？？？？
}

-(double) memoryaddition:(double)plusnumber{
    _memory=_memory+plusnumber;
    return _memory;
}

-(double) memorysubtraction:(double)subnumber{
    _memory=_memory-subnumber;
    return _memory;
}

-(NSString*) addition:(NSString*) plusnumber1 andPlusNumber: (NSString*) plusnumber2{
    if ([plusnumber1 isEqualToString:@"Whrong input!Please Check your Enter."]||[plusnumber2 isEqualToString:@"Whrong input!Please Check your Enter."]) {
        return @"Whrong input!Please Check your Enter.";
    }
    CGFloat result=[plusnumber1 floatValue]+[plusnumber2 floatValue];
    return [NSString stringWithFormat:@"%.2f",result];
}

-(NSString*) subtaction:(NSString*) subnumber1 andSubNumber: (NSString*) subnumber2{
    if ([subnumber1 isEqualToString:@"Whrong input!Please Check your Enter." ]||[subnumber2 isEqualToString:@"Whrong input!Please Check your Enter."]) {
        return @"Whrong input!Please Check your Enter.";
    }
        CGFloat result=[subnumber1 floatValue]+(-[subnumber2 floatValue]);
        return [NSString stringWithFormat:@"%.2f",result];
}

-(NSString*) multiplication:(NSString*) multinumber1 andMultiNumber: (NSString*) multinumber2{
    if ([multinumber1 isEqualToString:@"Whrong input!Please Check your Enter."]||[multinumber2 isEqualToString:@"Whrong input!Please Check your Enter."]) {
        return @"Whrong input!Please Check your Enter.";
    }
    CGFloat result=[multinumber1 floatValue]*[multinumber2 floatValue];
    return [NSString stringWithFormat:@"%.2f",result];

}

-(NSString*) remainderation:(NSString *)remnumber1 andRemNumber:(NSString *)remnumber2{
    if ([remnumber1 isEqualToString:@"Whrong input!Please Check your Enter."]||[remnumber2 isEqualToString:@"Whrong input!Please Check your Enter."]) {
        return @"Whrong input!Please Check your Enter.";
    }
...
-(NSString*) division:(NSString*) divnumber1 andDivNumber: (NSString*) divnumber2{
    if ([divnumber1 isEqualToString:@"Whrong input!Please Check your Enter."]||[divnumber2 isEqualToString:@"Whrong input!Please Check your Enter."]) {
        return @"Whrong input!Please Check your Enter.";
    }
    CGFloat result=[divnumber1 floatValue]/[divnumber2 floatValue];
    return [NSString stringWithFormat:@"%.2f",result];
}
...
-(NSString*) unperantheses:(NSString*) perantheses{
    if ([self checkperantheses:perantheses]) {
        ...
        if (leftperanthese.length>0) {
            ...
            if (rightperanthese.location<9223372036854775800) {
