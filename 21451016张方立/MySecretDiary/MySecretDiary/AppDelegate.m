...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MySceretDiary" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MySecretDiary.sqlite"];
...
-(void)firstStartAfterFreshInstall
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:0 forKey:@"diaryBooks"];
