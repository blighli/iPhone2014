...
@interface HerViewController ()<UIWebViewDelegate>
@property (strong,nonatomic) UserModel* userModel;
@property (nonatomic,strong) webServiceApi* webRequest;
@property (nonatomic,strong) NSArray *herArray;
@end

@implementation HerViewController
@synthesize herArray;
NSInteger herLoadPage=1;
...

{
    [serialQueue addOperationWithBlock:^{
        herArray=[_webRequest requestForHerTimeLineWithScreenName:@"NBA" andPage:herLoadPage andPageCount:20];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row==0) {
        ...
        PublicLIneModel *model=[herArray objectAtIndex:indexPath.section];
