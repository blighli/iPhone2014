...
//       
//        NSLog(@"isCompleted: %@", info.isCompleted);
//    }
    return YES;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TodoListWithCoreData" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TodoListWithCoreData.sqlite"];
    NSError *error = nil;
