...
{
//     xGet the new view controller using [segue destinationViewController].
...
{
    _myAlert = [[UIAlertView alloc]initWithTitle:@"Edit the task" message:@"this area should not be vacant" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"OK", nil];
...
- (void)alertView: (UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    switch (buttonIndex) {
        ...
        case 1:
        {
            ...
            UITextField *content = [_myAlert textFieldAtIndex:0];
