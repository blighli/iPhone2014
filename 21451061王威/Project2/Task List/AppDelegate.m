...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Update the data" message:@"" delegate:self cancelButtonTitle:@"cancel" otherButtonTitles:@"update", nil];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex{
    if (buttonIndex == 1) {
        ...
        tasks[self.indexPath.row] = [textField text];
        [taskTable reloadData];
    }
}
