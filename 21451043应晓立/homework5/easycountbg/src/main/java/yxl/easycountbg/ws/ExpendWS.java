...
@RestController
public class ExpendWS {
	
	@RequestMapping(value="/expend/listbyday")
	public @ResponseBody String getExpendList(@RequestParam(value="username",required=true) String username,
			@RequestParam(value="year",required=true) int year,
			@RequestParam(value="month",required=true) int month,
			@RequestParam(value="day",required=true) int day) {
		String sqlString="select * from expend where username='"+username+"' and year="+year+" and month="+month+" and day="+day;
	...
	@RequestMapping(value="/expend/add")
	public String addExpendRecord(@RequestParam(value="record",required=true) String recordStr) {
		...
		String sqlString="insert into expend(username,addTime,money,des,type,accountType,year,month,day) values('"
		...
		String queryString="select * from expend order by id desc limit 1 ";
	...
	@RequestMapping(value="/expend/edit")
	public String editExpendRecord(@RequestParam(value="record",required=true) String recordStr) {
		System.out.println(recordStr);
		JSONObject recordJsonObject=JSONObject.parseObject(recordStr);
		System.out.println(recordJsonObject);
		Record record=(Record)JSONObject.toJavaObject(recordJsonObject, Record.class);
		String sqlString="update expend set money="+record.getMoney()+",des='"+record.getDes()+"',type="+record.getType()+",accountType="+record.getAccountType()+" where id="+record.getId();
		Connection connection=EasyCountDao.getEasyCountDBConnection();
	...
	@RequestMapping(value="/expend/delete")
	public String deleteExpendRecord(@RequestParam(value="id",required=true) int id) {
		System.out.println(id);
		String sqlString="delete from expend where id="+id;
		Connection connection=EasyCountDao.getEasyCountDBConnection();
		int res=EasyCountDao.excuteOper(sqlString, connection);
		if (res>0) {
			return "1";
	...
	@RequestMapping(value="/expend/countByYear")
	public @ResponseBody String countByYear(@RequestParam(value="username",required=true) String username,
			@RequestParam(value="year",required=true) int year){
		String sqlString="select type,sum(money) as sum from expend where username='"+username+"' and year="+year+" group by type";
		System.out.println(sqlString);
		Connection connection=EasyCountDao.getEasyCountDBConnection();
		ResultSet resultSet=EasyCountDao.excuteQueryOper(sqlString, connection);
		JSONArray recordJsonArray=new JSONArray();
	...
	@RequestMapping(value="/expend/countByMonth")
	public @ResponseBody String countByMonth(@RequestParam(value="username",required=true) String username,
			@RequestParam(value="year",required=true) int year,
			@RequestParam(value="month",required=true) int month){
		String sqlString="select type,sum(money) as sum from expend where username='"+username+"' and year="+year+" and month="+month+" group by type";
		System.out.println(sqlString);
		Connection connection=EasyCountDao.getEasyCountDBConnection();
		ResultSet resultSet=EasyCountDao.excuteQueryOper(sqlString, connection);
		JSONArray recordJsonArray=new JSONArray();
	...
	@RequestMapping(value="/expend/countByDay")
	public @ResponseBody String countByDay(@RequestParam(value="username",required=true) String username,
			@RequestParam(value="year",required=true) int year,
			@RequestParam(value="month",required=true) int month,
			@RequestParam(value="day",required=true) int day){
		String sqlString="select type,sum(money) as sum from expend where username='"+username+"' and year="+year+" and month="+month+" and day="+day+" group by type";
		System.out.println(sqlString);
		Connection connection=EasyCountDao.getEasyCountDBConnection();
		ResultSet resultSet=EasyCountDao.excuteQueryOper(sqlString, connection);
		JSONArray recordJsonArray=new JSONArray();
