...
- (void)addTask:(id)sender
{
    ...
    UIViewController * next = [storybord    instantiateViewControllerWithIdentifier:@"ContentView"] ;
	
	[[TaskStore sharedStore] setIndexState:-1];
	
    [self presentViewController:next animated:YES completion:nil];
    
//    ContentViewController *next = [[self storyboard] instantiateViewControllerWithIdentifier:@"contentview"];
//    [self presentViewController:next animated:YES completion:nil];
//    [av show];
...
//    [self.tableView reloadData];
	...
	[taskStore setIndexState:indexPath.row];
