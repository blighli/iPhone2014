...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    taskField = [[UITextField alloc] initWithFrame:fieldFrame]; [taskField setBorderStyle:UITextBorderStyleRoundedRect];
...
{
    update = index;
    UIAlertView * alertView = [[UIAlertView alloc] initWithTitle:@"修改内容"
                                                         message:@" "
                                                        delegate:self
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 1) {
        ...
        tasks[update.row] = tmpField.text;
